...
class UtilsTest {
    ...
    @Test
    fun getStackTraceStringReturnsEmptyStringWithNull() {
        assertThat(Utils.getStackTraceString(null)).isEqualTo("")
    }

    @Test
    fun getStackTraceStringReturnEmptyStringWithUnknownHostException() {
    ...
    @Test
    fun toStringWithNull() {
        assertThat(Utils.toString(null)).isEqualTo("null")
    }

    @Test
    fun primitiveArrayToString() {
    ...
    @Test
    fun multiDimensionArrayToString() {
